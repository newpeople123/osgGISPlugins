...
#include <iostream>
void MeshSimplifier::reindexMesh(osg::ref_ptr<osg::Geometry> geom)
{
	if (geom.valid()) {
...
template<typename DrawElementsType, typename IndexArrayType>
void MeshSimplifier::simplifyPrimitiveSet(osg::ref_ptr<osg::Geometry> geom, osg::ref_ptr<DrawElementsType> drawElements, const float simplifyRatio, unsigned int& psetIndex)
{
