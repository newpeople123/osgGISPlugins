...
namespace osgGISPlugins {
    ...
    private:
        ...
        template<typename DrawElementsType, typename IndexArrayType>
        osg::ref_ptr<IndexArrayType> reindexMesh(osg::ref_ptr<osg::Geometry> geom, osg::ref_ptr<DrawElementsType> drawElements, const unsigned int psetIndex, osg::MixinVector<unsigned int>& remap, const bool bGenerateIndex = true, const size_t uniqueVertexNum = 0);
...
#pragma endregion
    ...
    template<typename DrawElementsType, typename IndexArrayType>
    inline osg::ref_ptr<IndexArrayType> MeshOptimizer::reindexMesh(osg::ref_ptr<osg::Geometry> geom, osg::ref_ptr<DrawElementsType> drawElements, const unsigned int psetIndex, osg::MixinVector<unsigned int>& remap, const bool bGenerateIndex, const size_t uniqueVertexNum)
    {
        osg::ref_ptr<osg::FloatArray> batchIds = dynamic_cast<osg::FloatArray*>(geom->getVertexAttribArray(0));
        osg::ref_ptr<osg::Vec3Array> positions = dynamic_cast<osg::Vec3Array*>(geom->getVertexArray());
