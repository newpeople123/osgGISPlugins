...
int main(int argc, char** argv)
{
    ...
    if (node.valid()) {
        ...
        std::string textureFormat = "png", vertexFormat = "none", treeFormat = "quad", maxTriangle = "40000", simplifiedRatio = "0.5", latitude = "30", longitude = "116", height = "300";
        ...
        std::string optionStr = "textureType=" + textureFormat + " compressionType=" + vertexFormat;
