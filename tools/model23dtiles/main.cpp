...
int main(int argc, char** argv)
{
    ...
    std::string input = "D:\\Data\\芜湖水厂总装1.fbx", output = "D:\\nginx-1.24.0\\html\\3dtiles\\singleThread";
    ...
    if (node.valid()) {
        ...
        std::string textureFormat = "png", vertexFormat = "meshopt", treeFormat = "quad", maxTriangle = "40000", simplifiedRatio = "0.5", latitude = "30", longitude = "116", height = "300", comporessLevel="high";
