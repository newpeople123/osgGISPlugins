...
#else
        osg::ref_ptr<osg::Object> object = osgDB::readObjectFile(osgDB::convertStringFromCurrentCodePageToUTF8(*itr));
#endif // !NDEBUG
        if (object.valid())
        {
...
#else
        osgDB::ReaderWriter::WriteResult result = osgDB::Registry::instance()->writeNode(*root, osgDB::convertStringFromCurrentCodePageToUTF8(fileNameOut), osgDB::Registry::instance()->getOptions());
#endif // !NDEBUG
